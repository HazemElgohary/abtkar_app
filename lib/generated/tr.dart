...
/// `ar` => `تم التحميل بنجاح`
/// `en` => `download done`
static String get downloadDone => 'download_done' ;
/// `ar` => `غير متصل بالشبكة من فضلك تاكد من الاتصال بالشبكة`
/// `en` => `you are not connected please connect to network`
static String get youAreNotConnected => 'you_are_not_connected' ;
/// `ar` => `تحميل`
/// `en` => `download`
...
/// `ar` => `المشاهير`
/// `en` => `Popular People`
static String get popularPeople => 'popular_people' ;
/// `ar` => `ابتكار`
/// `en` => `abtkar`
static String get abtkar => 'abtkar' ;}